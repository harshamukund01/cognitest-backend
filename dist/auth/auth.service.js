...
let AuthService = class AuthService {
    ...
    constructor(prisma, jwtService) {
        ...
        this.googleClient = new google_auth_library_1.OAuth2Client(process.env.GOOGLE_CLIENT_ID || 'your-google-client-id.apps.googleusercontent.com');
    }
    async register(dto) {
    ...
    getOtpHtmlTemplate(otp, isPasswordReset) {
...
<body style="margin: 0; padding: 0; background-color: #F8F9FA; font-family: 'Inter', 'Segoe UI', Arial, sans-serif; -webkit-font-smoothing: antialiased;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color: #F8F9FA; padding: 40px 20px;">
    ...
    async signToken(userId, email, role, isOnboarded) {
        const payload = {
            sub: userId,
            email,
            role,
